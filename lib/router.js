...
// Anilist
router.get('/anilist/user/:user/:status', require('./routes/anilist/user'));
// router.get('/anilist/user/forum/:id', require('./routes/anilist/forum'));
// router.get('/anilist/user/forum/:status', require('./routes/anilist/forum'));
// router.get('/anilist/user/review/:status', require('./routes/anilist/review'));
